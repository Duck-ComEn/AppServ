	...
	<div id="body_area">
		...
		<div class="midarea">
			...
			<div class="body_textarea">
				...
				<div align="justify">แสดงรายชื่อพนักงานทั้งหมดที่มีอยู่ในฐานข้อมูล</div>
				<div><a href="admin-pdf-all.php" target="_blank"><img src="images\PDF_Logo.png" align="right" border="0" width="64" height="64"></a><a href="admin-xls-all.php" target="_blank"><img src="images\Excel2007Logo.png" align="right" border="0" width="60" height="64"></a></div>
			</div>
			<div class="body_textarea">
				<div id="mytable">
				<table id="mytable"  cellspacing="0">
					 <?php
						...
						echo"<tr><th>E/N</th><th>Name</th><th>course</th><th>Time</th><th>Remain Time</th></tr>";
