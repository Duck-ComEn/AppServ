	...
	<div id="body_area">
		...
		<div class="midarea">
			...
			<div class="body_textarea">
				<div align="justify">แจ้งเตือนเหลืออีก 14 วันครบกำหนดการสอบ<br>
				<a href="admin-pdf-14.php" target="_blank"><img src="images\PDF_Logo.png" align="right" border="0" width="64" height="64"></a><a href="admin-exl-14.php" target="_blank"><img src="images\Excel2007Logo.png" align="right" border="0" width="60" height="64"></a></div>
			</div>
			<div class="body_textarea">
				<div id="mytable">
				<table id="mytable" cellspacing="0">
					...
					if($n<=0){
						...
						echo"<tr><th>E/N</th><th>Name</th><th>Course</th><th>Time</th><th>NextTime</th></tr>";
						//echo"<tr><th>E/N</th></tr>";
						for($i=1;$i<$n;$i++){
							echo"<tr><td>{$a[$b[$i]][0]}</td><td>{$a[$b[$i]][1]}</td><td>{$a[$b[$i]][2]}</td><td>{$a[$b[$i]][3]}</td><td>{$a[$b[$i]][4]}</td></tr>";
						}
					}
