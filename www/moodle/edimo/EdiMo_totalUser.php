...
<title>Edi-Mo Web Application : Total Users</title>
</head>
...
print("link[0] = \"<img src='icons/icon02.gif'>ทุกวิชาในระบบ|EdiMo_totalUser.php?mdl_course_categories_id=*|ทุกวิชาในระบบ\";");
$i = 1;
while($rs = $mysql->fetchArray()) {
	print("link[" . $i . "] = \"<img src='icons/icon02.gif'>" . $rs["nameTH"] . "|EdiMo_totalUser.php?mdl_course_categories_id=" . $rs["mdl_course_categories_id"] . "|" . $rs["nameTH"] . "\";");
	++$i;
}
?>
    ...
    <td colspan="3" >&nbsp;</td>
        ...
        <td colspan="3" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0" >
          <tr>
            ...
            <td height="28" align="center"><div align="left"><span class="style13">&nbsp;<img src="icons/stat.gif" alt="stat" width="23" height="23" /><span class="style14 style24"> Top Twenty Course  : สถิติจำนวนผู้เข้าใช้งาน <img src="icons/icon02.gif" width="3" height="6"></span></span><span class="style28"> <?=$mdl_course_categories_name?>
            </span></div></td>
            </tr>
          <tr>
            <td ><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" >
              <tr >
                <td align="left" ><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="1">
                    <tr>
                      <td valign="top"><table width="100%" border="1" cellpadding="0" cellspacing="0">
                        <tr bordercolor="#FFFFFF">
                          ...
                          <td width="9%" align="center" bordercolor="#FFFFFF" bgcolor="#CCCCCC"><span class="style4"><strong>จำนวนผู้ใช้งาน</strong></span></td>
						...
						$sql = "SELECT T1.mdl_course_id, T1.totalUsers, ";
						...
						$sql .= "ORDER BY T1.totalUsers DESC ";
						$sql .= "LIMIT 0, 20 ";
						//print $sql . "<br>";
						$result = $mysql->executeQuery($sql);
						$i = 0;
					  ...
					  ?>
                        <tr bgcolor="<?=$i % 2 != 0 ? "#EEEEEE" : "#F5F5F5"?>" bordercolor="#FFFFFF">
                          ...
                          <td align="center"><?=number_format($rs["totalUsers"], 0)?></td>
                    ...
                    <p align="right"><strong>ปรับปรุงข้อมูลล่าสุดเมื่อ</strong> <span class="style31">วันที่
                        <?=$date_update?>
                    </span></p></td>
              </tr>
            </table></td>
