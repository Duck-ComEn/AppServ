...
<div id="container"> 
  <div id="header">
    ...
    <p align="right" class="style4"><span class="style1">ยินดีต้อนรับ คุณ</span><span class="style3"><?php echo $_SESSION['MM_FirstName'].' '.$_SESSION['MM_LastName'] ;?></span></p>
  <!-- end #header --></div>
  <div id="sidebar1">
  ...
  <div id="mainContent">
    <h2 align="left">รายงานผลการสอบ</h2>
    <table width="710" border="0">
      <tr>
        <td width="88"><div align="left"><strong>คุณชื่อ</strong></div></td>
