				...
				/*		$result1=mysql_query("SELECT
					...
					/*	$result2=mysql_query("SELECT
						...
						$idat=mysql_result($result,$i,7);
							...
							echo"<tr><td align=center>".$u++.".</td><td>".$a[$i][0]."</td><td>{$a[$i][1]}</td><td>{$a[$i][2]}</td><td>".$a[$i][3]; if(@in_array($idat, $notshow3)){ echo"&nbsp;&nbsp;<a href=super_admin-show.php?id=".$idat."><img src=images/show1.gif></a>";}else{echo"&nbsp;&nbsp<a href=super_admin-notshow.php?id=".$idat."><img src=images/hide1.gif></a>";}echo"</td><td>";if($a[$i][4]=='expire'){echo "<a href=super_admin-expire.php?id=".$idat.">expire</a>";}else {echo $a[$i][4];}echo"&nbsp;&nbsp;<input name=\"btnButton1\" type=\"button\" value=\"S\" OnClick=\"JavaScript:fncAlert('".ucwords($a[$i][5])."');\"></td></tr>";
						}
