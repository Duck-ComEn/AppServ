	...
	<div id="body_area">
		...
		<div class="midarea">
			...
			<div class="body_textarea">
				...
				<div><a href="#" target="_blank"><img src="images\Mail_logo4.png" align="right" border="0" width="64" height="64" alt="Mail"></a><a href="admin-pdf-all.php?sup=<?php echo $_GET[sel_product]?>" target="_blank"><img src="images\PDF_Logo.png" align="right" border="0" width="64" height="64"></a><a href="admin-xls-all.php?sup=<?php echo $_GET[sel_product]?>" target="_blank"><img src="images\Excel2007Logo.png" align="right" border="0" width="60" height="64"></a></div>
			</div>
			<div class="body_textarea">
				<div id="mytable">
				...
				/*		$result1=mysql_query("SELECT
					...
					/*	$result2=mysql_query("SELECT
						...
						$idat=mysql_result($result,$i,7);
							...
							echo"<tr><td align=center>".$u++.".</td><td>".$a[$i][0]."</td><td>{$a[$i][1]}</td><td>{$a[$i][2]}</td><td>".$a[$i][3]; if(@in_array($idat, $notshow3)){ echo"&nbsp;&nbsp;<a href=show.php?id=".$idat."><img src=images/show1.gif></a>";}else{echo"&nbsp;&nbsp<a href=notshow.php?id=".$idat."><img src=images/hide1.gif></a>";}echo"</td><td>";if($a[$i][4]=='expire'){echo "<a href=expire.php?id=".$idat.">expire</a>";}else {echo $a[$i][4];}echo"&nbsp;&nbsp;<input name=\"btnButton1\" type=\"button\" value=\"S\" OnClick=\"JavaScript:fncAlert('".ucwords($a[$i][5])."');\"></td></tr>";
						}
