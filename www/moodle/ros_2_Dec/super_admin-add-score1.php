...
<head>
	...
	<?php
		...
		case "superadmin" : 
	?>
	<title>Benchmark Garde - SuperAdministrator::เพิ่มคะแนนรายบุคคล</title>
...
<body>
	...
	<div id="body_area">
		...
		<div class="midarea">
			...
			<div class="body_textarea">
                        ...
                        <td><table width="332" border="0">
                          ...
                          <tr>
							...
							$("#dateInput").datepicker();
                                ...
                                <input type="text" name="dateInput" id="dateInput" value="<?php echo $date;?>" />
                            </td>
                          </tr>
                          <tr>
				...
				$result2=mysql_query("SELECT
									...
									WHERE
										...
										echo"<tr><td>".$data['subject']."</td><td align=center>";if($data['time1']=='0'){ echo "-";}else {echo round(($data['time1']/$data['max']),2)*100 .'%';} echo"</td><td align=center>";if($data['time2']=='0'){ echo "-";}else {echo round(($data['time2']/$data['max']),2)*100 .'%';} echo"</td><td align=center>";if($data['time3']=='0'){ echo "-";}else {echo round(($data['time3']/$data['max']),2)*100 .'%';} echo"</td><td align=center>{$day1}</td><td align=center><a href=\"super_admin-del-score.php?id={$data['id']}\">Delete</a></td></tr>";
										}echo"</table>";
										}
			...
			echo "<meta http-equiv='refresh' content='0;URL=super_admin-add-score.php'>";
			          }
