	...
	<div id="body_area">
		<div class="left">
			...
			<div align="right">
				...
				<a href="logout.php" class="left_menu">ออกจากระบบ</a><br />
                <a href="logout.php" class="left_menu">ออกจากระบบ2</a><br /></div>
			</div>
		</div>
		...
		<div class="midarea">
			...
			<div class="body_textarea">
				...
				<div><a href="admin-pdf-all.php?sup=<?php echo $_GET[sel_product]?>"><img src="images\PDF_Logo.png" align="right" border="0" width="64" height="64"></a><a href="admin-xls-all.php?sup=<?php echo $_GET[sel_product]?>"><img src="images\Excel2007Logo.png" align="right" border="0" width="60" height="64"></a></div>
			</div>
			<div class="body_textarea">
				<div id="mytable">
