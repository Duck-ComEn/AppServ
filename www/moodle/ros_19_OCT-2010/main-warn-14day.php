			...
			<div class="body_textarea">
				<div align="justify">
				  ...
				  <form id="form1" name="form1" method="get" action="main-warn-14day.php">
                    ...
                    <div><a href="admin-pdf-14.php?sup=<?php echo $_GET[sel_product]?>"><img src="images\PDF_Logo.png" align="right" border="0" width="64" height="64"></a><a href="admin-exl-14.php?sup=<?php echo $_GET[sel_product]?>"><img src="images\Excel2007Logo.png" align="right" border="0" width="60" height="64"></a></div>
			</div>
			<div class="body_textarea">
				<div id="mytable">
