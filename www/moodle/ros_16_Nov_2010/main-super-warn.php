...
<head>
	...
	<?php
		...
		case "super" : 
	?>
	<title>Benchmark Garde - Supervisor::แจ้งเตือนทั้งหมด</title>
	...
	<div id="body_area">
		...
		<div class="midarea">
			...
			<div class="body_textarea">
				<div align="justify" style="font-size: 16pt">แจ้งเตือนการสอบ</div>
				<div align="justify">แสดงการแจ้งเตือนการสอบของพนักงานในความดูแลของท่านทั้งหมด<br>
				<a href="super-pdf-all.php" target=_blank><img src="images\PDF_Logo.png" align="right" border="0" width="64" height="64"></a><a href="super-xls-all.php" target=_blank><img src="images\Excel2007Logo.png" align="right" border="0" width="60" height="64"></a></div>
			</div>
			<div class="body_textarea">
				<div id="mytable">
				<table id="mytable" cellspacing="0">
					...
					union ALL
						...
						@$num_rows=mysql_num_rows($result);
						if(!$num_rows){
							echo "<meta http-equiv='refresh' content=0;URL=main-super-warn.php>";
						}
						$p=1;
					$t=0;
					...
					if($n<=0){
						...
						for($i=0;$i<$n;$i++){
							echo"<tr><td align=center>".($i+1).".</td><td>{$a[$i][0]}</td><td>{$a[$i][1]}</td><td>{$a[$i][2]}</td><td>{$a[$i][3]}</td><td>{$a[$i][4]}</td></tr>";
						}
					}
