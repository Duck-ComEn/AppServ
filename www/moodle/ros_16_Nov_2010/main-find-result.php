								...
								if($num_rows>0){
									...
									for($i=0;$i<$num_rows;$i++){
										...
										$p=1;
															...
															WHERE
																mdl_user.idnumber = '".$_GET['idnumber']."' ORDER BY
										...
										echo"<tr><td>{$data['subject']}</td><td align=center>";if($data['time1']=='0'){ echo "-";}else {echo round(($data['time1']/$data['max']),2)*100 .'%';} echo"</td><td align=center>";if($data['time2']=='0'){ echo "-";}else {echo round(($data['time2']/$data['max']),2)*100 .'%';} echo"</td><td align=center>";if($data['time3']=='0'){ echo "-";}else {echo round(($data['time3']/$data['max']),2)*100 .'%';} echo"</td><td align=center>{$day1}</td><td align=center>{$day2}</td></tr>";
										}
									echo"</table>";
								}//if >0
