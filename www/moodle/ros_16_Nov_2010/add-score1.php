...
<body>
	...
	<div id="body_area">
		...
		<div class="midarea">
			...
			$result=mysql_query("insert into ros_score(uid,subject,time1,time2,time3,max,date_time,next_date,added) values('".$_SESSION['id']."','".$_POST['subject']."','".$_POST['1']."','".$_POST['2']."','".$_POST['3']."','".$_POST['max']."','".$years."','".$next."',1)");
