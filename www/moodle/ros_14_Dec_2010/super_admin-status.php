		...
		<div class="midarea">
			...
			<div class="body_textarea">
				...
				function duration($begin,$end){
					...
					if($remove<0){
					echo"<tr><td>".$u++."</td><td>{$value['shortname']}</td><td>{$value['fullname']}</td><td align=center>".$q['mon'].'/'.$q['mday'].'/'.$q['year']."</td><td align=center>".$remove."</td><td align=center>";if(!$value['visible']){echo"<a href=super_admin-show-c.php?id=".$value['id']."><img src=images/show1.gif></a>";}else{echo"<a href=super_admin-notshow-c.php?id=".$value['id']."><img src=images/hide1.gif></a>";}echo"</td></tr>";
					}
					}
					echo"</table>";
