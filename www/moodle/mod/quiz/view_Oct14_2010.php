...
// This page prints a particular instance of quiz
    ...
    if ($attempts) {
		...
		// เพิ่ม EN ของชื่อพนักงาน  15 Sep 2010
		echo "<center><h3>E/N : ".$USER->idnumber."&nbsp;&nbsp;".$USER->firstname." ".$USER->lastname."</h3></center>";
		//echo $USER->username;
		//echo $COURSE->id;
        ...
        if ($gradecolumn) {
            $table->head[] = get_string('grade') . " / $quiz->grade"." (percent%)";
            $table->align[] = 'center';
            $table->size[] = '';
        }
        if ($feedbackcolumn) {
...
//calculate percent of each users score  /// ป้อง 15 Sep 2010
...
//end calcuate
            ...
            $attemptgrade = quiz_rescale_grade($attempt->sumgrades, $quiz)." ($resultpercent%)";
