...
<head>
	...
	?>
	<title>Benchmark Garde - Administrator::CheckMail</title>
	...
	<div id="body_area">
		...
		<div class="midarea">
			...
			<div class="body_textarea">
				<div align="justify">รายละเอียดการอ่าน mail ของ Supervisor <?php echo ucwords($_GET['sup'])?><br>
<?php
$result=mysql_query("SELECT
							ros_mail.id,
							ros_mail.link,
...
echo"<table>";
$c=1;
echo"<tr><th>ลำดับ</th><th>เวลาที่ส่ง</th><th>จำนวนครั้งที่อ่าน</th><th>เวลาที่อ่านล่าสุด</th></tr>";
while($data=mysql_fetch_array($result)){
...
echo"<tr><td>".$c++."</td><td>".$sent_time."</td><td align=center>";if($data['status']==0){echo"-";}else{echo $data['status'];}echo"</td><td>".$rev_time."</td></tr>";
}
echo"</table>";
