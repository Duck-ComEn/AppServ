...
echo '<ul><form class="loginform" id="login" method="post" action="'.$wwwroot.'/login/index.php?authldap_skipntlmsso=1">';
...
echo '<li>|</li>';
echo '<li><a href="http://vle.newbury-college.ac.uk/mod/resource/view.php?id=6803">Live Mail</a></li>';
echo '<li>|</li>';
